 ...
 *
 * The photo is the team portrait (container12): Dr. Christine front and
 * center with the real brass sunburst mirror behind her. The drawn Dial does
 * not render here, since its arcs would cross faces; the photographed mirror
 * carries the motif and the gauge row directly below picks it up. Below lg
 * the portrait sits above the copy so all three faces stay clear of text; on
 * lg it anchors right, top aligned so the mirror stays whole, and fades into
 * the espresso band behind the headline.
 *
...
export function HomeHero() {
  ...
  return (
    <section className="band band-espresso-deep relative flex flex-col overflow-hidden lg:min-h-[680px]">
      <div className="relative aspect-[4/3] max-h-[58svh] w-full shrink-0 overflow-hidden sm:aspect-[16/9] lg:absolute lg:inset-y-0 lg:right-0 lg:aspect-auto lg:max-h-none lg:w-[62%]">
        <motion.div
        ...
        >
          <img
            src={asset("/assets/images/container12.jpg")}
            alt="Dr. Christine Hanczaryk, center, smiling with two members of her team in the HCNG lobby, in front of the brass sunburst mirror"
            width={1632}
            height={1084}
            fetchPriority="high"
            className="absolute inset-0 h-full w-full object-cover object-top lg:object-[28%_0%] xl:object-[42%_0%]"
          />
        </motion.div>
